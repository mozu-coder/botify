...
async def process_followup_step(update: Update, context: ContextTypes.DEFAULT_TYPE, step_num: int, skipped: bool = False):
    ...
    if not skipped:
        ...
        if msg.photo or msg.video or msg.document:
            await msg.reply_text("❌ <b>Erro:</b> A recuperação deve ser apenas texto.", parse_mode="HTML")
            return step_num
    ...
    if next_step <= 3:
        ...
        msg_final = "O bot usará o padrão do sistema." if count == 0 else f"O bot alternará entre suas {count} mensagens."
        ...
        if update.callback_query:
             ...
             await update.message.reply_text(text, reply_markup=bot_management_keyboard(saved_bot), parse_mode="HTML")
